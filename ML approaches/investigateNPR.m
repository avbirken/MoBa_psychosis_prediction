...
results = load(fullfile(dirWork, 'analysis_RUS', 'Results_RUS_NPR_workSet.mat'), 'numOuterFolds', 'numRepeats', 'allSeeds', 'parentID', 'allClasses', 'testPrd');

%% Load the dataset
load(fullfile(dirWork, 'NPR_workSet.mat'));
data = NPR_workSet;
clear NPR_workSet
...
%% Save
save(fullfile(dirOut, 'insights_NPR.mat'), '-v7.3');