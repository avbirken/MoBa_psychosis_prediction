%% Run RUSBoost model for CAPE + Q14 + NPR
%% Set paths etc.
...
toLoad2 = 'Q14.mat';
toLoad3 = 'NPR.mat';
toSave  = 'Results_fuse_RUS_CAPE_Q14_NPR.mat';
load(fullfile(dirWork, toLoad));
load(fullfile(dirWork, toLoad2));
load(fullfile(dirWork, toLoad3))
...
locFeatures_2 = 4:size(data2,2);
locFeatures_3 = 4:size(data3,2);
locFeatures_F = 4:size(dataFuse,2);
...
stdLocs_3 = find(cell2mat(cellfun(@(x) numel(unique(x)) > 2, mat2cell(allFeatures_3, numObservations, ones(length(locFeatures_3),1)), 'UniformOutput', false)));
...
[trainPrd_3, trainWts_3, testPrd_3, testWts_3] = deal(cell(numOuterFolds, numRepeats));
...
[train_FP_3,          train_TP_3,    train_FN_3,     train_TN_3,        ...
 train_sensitivity_3, train_specificity_3, train_balAccuracy_3,         ...
 train_AUC_3,         train_brier_3, train_brier0_3, train_brier1_3,    ...
 test_FP_3,           test_TP_3,     test_FN_3,      test_TN_3,         ...
 test_sensitivity_3,  test_specificity_3,  test_balAccuracy_3,          ...
 test_AUC_3,          test_brier_3,  test_brier0_3,  test_brier1_3] =   ...
 deal(zeros(numOuterFolds, numRepeats));
...
[perm_trainPrd_3, perm_trainWts_3, perm_testPrd_3, perm_testWts_3] = deal(cell(numOuterFolds, numPermutations));
...
[perm_train_FP_3,          perm_train_TP_3,    perm_train_FN_3,     perm_train_TN_3,        ...
 perm_train_sensitivity_3, perm_train_specificity_3, perm_train_balAccuracy_3,              ...
 perm_train_AUC_3,         perm_train_brier_3, perm_train_brier0_3, perm_train_brier1_3,    ...
 perm_test_FP_3,           perm_test_TP_3,     perm_test_FN_3,      perm_test_TN_3,         ...
 perm_test_sensitivity_3,  perm_test_specificity_3,  perm_test_balAccuracy_3,               ...
 perm_test_AUC_3,          perm_test_brier_3,  perm_test_brier0_3,  perm_test_brier1_3] =   ...
 deal(zeros(numOuterFolds, numPermutations));
...
[mean_trainSensitivity_3, mean_trainSpecificity_3, mean_trainBalAccuracy_3, ...
 mean_trainBrierScore_3,  mean_trainBrierScore0_3, mean_trainBrierScore1_3, ...
 mean_trainAUC_3,         mean_testSensitivity_3,  mean_testSpecificity_3,  ...
 mean_testBalAccuracy_3,  mean_testBrierScore_3,   mean_testBrierScore0_3,  ...
 mean_testBrierScore1_3,  mean_testAUC_3] = deal(zeros(numRepeats, 1));
...
[perm_mean_trainSensitivity_3, perm_mean_trainSpecificity_3, perm_mean_trainBalAccuracy_3, ...
 perm_mean_trainBrierScore_3,  perm_mean_trainBrierScore0_3, perm_mean_trainBrierScore1_3, ...
 perm_mean_trainAUC_3,         perm_mean_testSensitivity_3,  perm_mean_testSpecificity_3,  ...
 perm_mean_testBalAccuracy_3,  perm_mean_testBrierScore_3,   perm_mean_testBrierScore0_3,  ...
 perm_mean_testBrierScore1_3,  perm_mean_testAUC_3] = deal(zeros(numPermutations, 1));
...
parfor rep = 1:numRepeats
    ...
    for folds = 1:numOuterFolds
        ...
        tmp_trainFeatures_3 = allFeatures_3(trainIDX{folds}, :); %#ok<PFBNS>
        tmp_testFeatures_3  = allFeatures_3(testIDX{folds},  :);
        tmp_trainCovars_3   = covars_3(trainIDX{folds}, :); %#ok<PFBNS>
        tmp_testCovars_3    = covars_3(testIDX{folds},  :);        
        ...
        % Train RUSBoost and make prediction using this trained model - 3
        [trainPrd_3{folds,rep}, trainWts_3{folds,rep}, testPrd_3{folds,rep},  testWts_3{folds,rep}] = ...
         doRUS(tmp_trainFeatures_3,   tmp_testFeatures_3,    tmp_trainClasses, ...
               tmp_trainCovars_3,     tmp_testCovars_3,      covarLocs_3,  stdLocs_3);        
        ...
        % Evaluate the model training performance - 3
        [train_FP_3(folds,rep), train_TP_3(folds,rep), train_FN_3(folds,rep), train_TN_3(folds,rep),         ...
         train_sensitivity_3(folds,rep), train_specificity_3(folds,rep), train_balAccuracy_3(folds,rep)] = ...
         checkPerf_extended(tmp_trainClasses, trainPrd_3{folds,rep});        
        ...
        % Evaluate the model test performance - 3
        [test_FP_3(folds,rep), test_TP_3(folds,rep), test_FN_3(folds,rep), test_TN_3(folds,rep),          ...
         test_sensitivity_3(folds,rep), test_specificity_3(folds,rep), test_balAccuracy_3(folds,rep)] = ...
         checkPerf_extended(tmp_testClasses, testPrd_3{folds,rep});        
        ...
        % Calculate area under the curve - 3
        [~, ~, ~, train_AUC_3(folds,rep)] = perfcurve(tmp_trainClasses, trainWts_3{folds,rep}(:,2), 1);
        [~, ~, ~, test_AUC_3(folds, rep)] = perfcurve(tmp_testClasses,  testWts_3{folds,rep}(:,2),  1);        
        ...
        % Stratified Brier score for training - 3
        [train_brier_3(folds,rep), train_brier0_3(folds,rep), train_brier1_3(folds,rep)] = ...
         stratified_brier_score(trainWts_3{folds,rep}(:,1), trainWts_3{folds,rep}(:,2), tmp_trainClasses);        
        ...
        % Stratified Brier score for test - 3
        [test_brier_3(folds,rep), test_brier0_3(folds,rep), test_brier1_3(folds,rep)] = ...
         stratified_brier_score(testWts_3{folds,rep}(:,1), testWts_3{folds,rep}(:,2), tmp_testClasses);        
...
for rep = 1:numRepeats
    ...
    mean_trainSensitivity_3(rep,1) = mean(train_sensitivity_3(:,rep));
    mean_trainSpecificity_3(rep,1) = mean(train_specificity_3(:,rep));
    mean_trainBalAccuracy_3(rep,1) = mean(train_balAccuracy_3(:,rep));
    mean_trainBrierScore_3(rep, 1) = mean(train_brier_3(:,rep));
    mean_trainBrierScore0_3(rep,1) = mean(train_brier0_3(:,rep));
    mean_trainBrierScore1_3(rep,1) = mean(train_brier1_3(:,rep));
    mean_trainAUC_3(rep,1)         = mean(train_AUC_3(:,rep));

    mean_testSensitivity_3(rep,1)  = mean(test_sensitivity_3(:,rep));
    mean_testSpecificity_3(rep,1)  = mean(test_specificity_3(:,rep));
    mean_testBalAccuracy_3(rep,1)  = mean(test_balAccuracy_3(:,rep));
    mean_testBrierScore_3(rep, 1)  = mean(test_brier_3(:,rep));
    mean_testBrierScore0_3(rep,1)  = mean(test_brier0_3(:,rep));
    mean_testBrierScore1_3(rep,1)  = mean(test_brier1_3(:,rep));
    mean_testAUC_3(rep,1)          = mean(test_AUC_3(:,rep));    
...
parfor rep = 1:numPermutations
    ...
    for folds = 1:numOuterFolds
        ...
        % Train RUSBoost and make prediction using this trained model - 3
        [perm_trainPrd_3{folds,rep}, perm_trainWts_3{folds,rep}, perm_testPrd_3{folds,rep},  perm_testWts_3{folds,rep}] = ...
         doRUS(tmp_trainFeatures_3,   tmp_testFeatures_3,    tmp_trainClasses, ...
               tmp_trainCovars_3,     tmp_testCovars_3,      covarLocs_3,  stdLocs_3);        
        ...
        % Evaluate the model training performance - 3
        [perm_train_FP_3(folds,rep), perm_train_TP_3(folds,rep), perm_train_FN_3(folds,rep), perm_train_TN_3(folds,rep),    ...
         perm_train_sensitivity_3(folds,rep), perm_train_specificity_3(folds,rep), perm_train_balAccuracy_3(folds,rep)] = ...
         checkPerf_extended(tmp_trainClasses, perm_trainPrd_3{folds,rep});        
        ...
        % Evaluate the model test performance - 3
        [perm_test_FP_3(folds,rep), perm_test_TP_3(folds,rep), perm_test_FN_3(folds,rep), perm_test_TN_3(folds,rep),     ...
         perm_test_sensitivity_3(folds,rep), perm_test_specificity_3(folds,rep), perm_test_balAccuracy_3(folds,rep)] = ...
         checkPerf_extended(tmp_testClasses, perm_testPrd_3{folds,rep});        
        ...
        % Calculate area under the curve - 3
        [~, ~, ~, perm_train_AUC_3(folds,rep)] = perfcurve(tmp_trainClasses, perm_trainWts_3{folds,rep}(:,2), 1);
        [~, ~, ~, perm_test_AUC_3(folds, rep)] = perfcurve(tmp_testClasses,  perm_testWts_3{folds,rep}(:,2),  1);        
        ...
        % Stratified Brier score for training - 2
        [perm_train_brier_3(folds,rep), perm_train_brier0_3(folds,rep), perm_train_brier1_3(folds,rep)] = ...
         stratified_brier_score(perm_trainWts_3{folds,rep}(:,1), perm_trainWts_3{folds,rep}(:,2), tmp_trainClasses);        
        ...
        % Stratified Brier score for test - 2
        [perm_test_brier_3(folds,rep), perm_test_brier0_3(folds,rep), perm_test_brier1_3(folds,rep)] = ...
         stratified_brier_score(perm_testWts_3{folds,rep}(:,1), perm_testWts_3{folds,rep}(:,2), tmp_testClasses);        
...
for rep = 1:numPermutations
    ...
    perm_mean_trainSensitivity_3(rep,1) = mean(perm_train_sensitivity_3(:,rep));
    perm_mean_trainSpecificity_3(rep,1) = mean(perm_train_specificity_3(:,rep));
    perm_mean_trainBalAccuracy_3(rep,1) = mean(perm_train_balAccuracy_3(:,rep));
    perm_mean_trainBrierScore_3(rep, 1) = mean(perm_train_brier_3(:,rep));
    perm_mean_trainBrierScore0_3(rep,1) = mean(perm_train_brier0_3(:,rep));
    perm_mean_trainBrierScore1_3(rep,1) = mean(perm_train_brier1_3(:,rep));
    perm_mean_trainAUC_3(rep,1)         = mean(perm_train_AUC_3(:,rep));

    perm_mean_testSensitivity_3(rep,1) = mean(perm_test_sensitivity_3(:,rep));
    perm_mean_testSpecificity_3(rep,1) = mean(perm_test_specificity_3(:,rep));
    perm_mean_testBalAccuracy_3(rep,1) = mean(perm_test_balAccuracy_3(:,rep));
    perm_mean_testBrierScore_3(rep, 1) = mean(perm_test_brier_3(:,rep));
    perm_mean_testBrierScore0_3(rep,1) = mean(perm_test_brier0_3(:,rep));
    perm_mean_testBrierScore1_3(rep,1) = mean(perm_test_brier1_3(:,rep));
    perm_mean_testAUC_3(rep,1)         = mean(perm_test_AUC_3(:,rep));    
