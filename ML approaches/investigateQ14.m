...
results = load(fullfile(dirWork, 'analysis_RUS', 'Results_RUS_Q14_workSet.mat'), 'numOuterFolds', 'numRepeats', 'allSeeds', 'parentID', 'allClasses', 'testPrd');

%% Load the dataset
load(fullfile(dirWork, 'Q14_workSet.mat'));
data = Q14_workSet;
clear Q14_workSet
...
%% Save
save(fullfile(dirOut, 'insights_Q14.mat'), '-v7.3');