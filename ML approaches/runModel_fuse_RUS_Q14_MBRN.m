%% Run RUSBoost model for Q14 + MBRN
%% Set paths etc.
...
toLoad  = 'Q14.mat';
toLoad2 = 'MBRN.mat';
toSave  = 'Results_fuse_RUS_Q14_MBRN.mat';
...
%% Initialize
[traiMBRNd_1, trainWts_1, testPrd_1, testWts_1] = deal(cell(numOuterFolds, numRepeats));
[traiMBRNd_2, trainWts_2, testPrd_2, testWts_2] = deal(cell(numOuterFolds, numRepeats));
[traiMBRNd_F, trainWts_F, testPrd_F, testWts_F] = deal(cell(numOuterFolds, numRepeats));
...
[perm_traiMBRNd_1, perm_trainWts_1, perm_testPrd_1, perm_testWts_1] = deal(cell(numOuterFolds, numPermutations));
[perm_traiMBRNd_2, perm_trainWts_2, perm_testPrd_2, perm_testWts_2] = deal(cell(numOuterFolds, numPermutations));
[perm_traiMBRNd_F, perm_trainWts_F, perm_testPrd_F, perm_testWts_F] = deal(cell(numOuterFolds, numPermutations));
...
parfor rep = 1:numRepeats
    ...
    for folds = 1:numOuterFolds
        ...
        [traiMBRNd_1{folds,rep}, trainWts_1{folds,rep}, testPrd_1{folds,rep},  testWts_1{folds,rep}] = ...
        ...
        [traiMBRNd_2{folds,rep}, trainWts_2{folds,rep}, testPrd_2{folds,rep},  testWts_2{folds,rep}] = ...
        ...
        [traiMBRNd_F{folds,rep}, trainWts_F{folds,rep}, testPrd_F{folds,rep},  testWts_F{folds,rep}] = ...
        ...
        [train_FP_1(folds,rep), train_TP_1(folds,rep), train_FN_1(folds,rep), train_TN_1(folds,rep),         ...
         ...
         checkPerf_extended(tmp_trainClasses, traiMBRNd_1{folds,rep});
        ...
        [train_FP_2(folds,rep), train_TP_2(folds,rep), train_FN_2(folds,rep), train_TN_2(folds,rep),         ...
         ...
         checkPerf_extended(tmp_trainClasses, traiMBRNd_2{folds,rep});
        ...
        [train_FP_F(folds,rep), train_TP_F(folds,rep), train_FN_F(folds,rep), train_TN_F(folds,rep),         ...
         ...
         checkPerf_extended(tmp_trainClasses, traiMBRNd_F{folds,rep});
...
parfor rep = 1:numPermutations
    ...
    for folds = 1:numOuterFolds
        ...
        % Train RUSBoost and make prediction using this trained model - 1
        [perm_traiMBRNd_1{folds,rep}, perm_trainWts_1{folds,rep}, perm_testPrd_1{folds,rep},  perm_testWts_1{folds,rep}] = ...
         doRUS(tmp_trainFeatures_1,   tmp_testFeatures_1,    tmp_trainClasses, ...
               tmp_trainCovars_1,     tmp_testCovars_1,      covarLocs_1,  stdLocs_1);

        % Train RUSBoost and make prediction using this trained model - 2
        [perm_traiMBRNd_2{folds,rep}, perm_trainWts_2{folds,rep}, perm_testPrd_2{folds,rep},  perm_testWts_2{folds,rep}] = ...
         doRUS(tmp_trainFeatures_2,   tmp_testFeatures_2,    tmp_trainClasses, ...
               tmp_trainCovars_2,     tmp_testCovars_2,      covarLocs_2,  stdLocs_2);

        % Train RUSBoost and make prediction using this trained model - fused
        [perm_traiMBRNd_F{folds,rep}, perm_trainWts_F{folds,rep}, perm_testPrd_F{folds,rep},  perm_testWts_F{folds,rep}] = ...
         doRUS(tmp_trainFeatures_F,   tmp_testFeatures_F,    tmp_trainClasses, ...
               tmp_trainCovars_F,     tmp_testCovars_F,      covarLocs_F,  stdLocs_F);
        ...
        [perm_train_FP_1(folds,rep), perm_train_TP_1(folds,rep), perm_train_FN_1(folds,rep), perm_train_TN_1(folds,rep),    ...
         ...
         checkPerf_extended(tmp_trainClasses, perm_traiMBRNd_1{folds,rep});
        ...
        [perm_train_FP_2(folds,rep), perm_train_TP_2(folds,rep), perm_train_FN_2(folds,rep), perm_train_TN_2(folds,rep),    ...
         ...
         checkPerf_extended(tmp_trainClasses, perm_traiMBRNd_2{folds,rep});
        ...
        [perm_train_FP_F(folds,rep), perm_train_TP_F(folds,rep), perm_train_FN_F(folds,rep), perm_train_TN_F(folds,rep),    ...
         ...
         checkPerf_extended(tmp_trainClasses, perm_traiMBRNd_F{folds,rep});        
