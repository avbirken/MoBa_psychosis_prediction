%% Run RUSBoost model for CAPE + Q14 social competence and relationship satisfaction
%% Set paths etc.
...
toLoad  = 'CAPE.mat';
toLoad2 = 'Q14.mat';
toSave  = 'Results_RUS_CAPE_Q14SocRel.mat';
load(fullfile(dirWork, toLoad));
load(fullfile(dirWork, toLoad2));

%% Subset Q14
toSelect  = {'ID_2445', 'ParentID', 'caseStatus', 'social_phobia', 'depression_SMFQ', 'bullying', 'parent_child_relationship', 'parent_child_conflict', 'disruptive_behavior_child_rated'};
locSelect = ismember(Q14.Properties.VariableNames, toSelect);
Q14       = Q14(:, locSelect);

%% Merge datasets
CAPE = innerjoin(CAPE, Q14);
