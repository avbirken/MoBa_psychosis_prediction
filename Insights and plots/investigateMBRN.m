...
results = load(fullfile(dirWork, 'analysis_RUS', 'Results_RUS_MBRN_workSet.mat'), 'numOuterFolds', 'numRepeats', 'allSeeds', 'parentID', 'allClasses', 'testPrd');

%% Load the dataset
load(fullfile(dirWork, 'MBRN_workSet.mat'));
data = MBRN_workSet;
clear MBRN_workSet
...
%% Save
save(fullfile(dirOut, 'insights_MBRN.mat'), '-v7.3');