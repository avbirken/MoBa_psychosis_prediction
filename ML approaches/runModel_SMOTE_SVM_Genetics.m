%% Run SMOTE+SVM model for Genetics
%% Set paths etc.
...
dirOut  = '/ess/p697/cluster/users/parekh/2024-11-11_predictionPsychosis_VB/work/analysis_SMOTE_SVM';
toLoad  = 'Genetics.mat';
toSave  = 'Results_SMOTE_SVM_Genetics_SCZ.mat';
...
parfor rep = 1:numRepeats
    ...
    for folds = 1:numOuterFolds
        ...
        [tmp_trainFeatures, tmp_trainClasses] = doSMOTE(tmp_trainFeatures, tmp_trainClasses, variant, catgLocs, sendDouble);

        % Fix transpose
        tmp_trainClasses = tmp_trainClasses';

        % Do SVM on resampled features
