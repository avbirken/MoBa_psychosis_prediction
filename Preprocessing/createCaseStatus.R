...
#Here, we set the case status for those with or without a diagnosed psychosis, given the predefined diagnostic cut-off
# Diagnostic cut-off for the cases:
# 1) anyone with a F2* or ICPC diagnosis after (Q14 response + 6 months)
...
# Within KUHR, remove code "2.16.578.1.12.4.1.1.71.7170" and one child with ICD-9
...
# Losing one ID because this subject is not in full MBRN
...
# Losing one subject at this stage - this subject does not seem to be in MBRN
