%% Run RUSBoost model for CAPE + Q14 substance use
%% Set paths etc.
...
toLoad  = 'CAPE.mat';
toLoad2 = 'Q14.mat';
toSave  = 'Results_RUS_CAPE_Q14SubstanceUse.mat';
load(fullfile(dirWork, toLoad));
load(fullfile(dirWork, toLoad2));

%% Subset Q14
toSelect  = {'ID_2445', 'ParentID', 'caseStatus', 'lifetime_alcohol', 'lifetime_cannabis', 'lifetime_other_drugs'};
